...
import { List, LayoutGrid, Handshake } from "lucide-react";
...
export function DealsPageClient({
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader
        title="Deals"
        subtitle="Manage your pipeline and track deal progress"
        icon={Handshake}
        actions={
          <div
          ...
          >
            <button
              ...
              style={{
                backgroundColor: view === "board" ? withAlpha(theme.accent, 0.15) : "transparent",
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium transition-all"
              style={{
                backgroundColor: view === "list" ? withAlpha(theme.accent, 0.15) : "transparent",
