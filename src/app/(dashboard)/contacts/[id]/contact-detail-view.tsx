...
import { CallRecordingsPanel } from "@/components/calls/CallRecordingsPanel";
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 pb-8">
        <div className="flex items-center gap-3 overflow-x-auto pb-1 -mb-1">
          {contact.phone ? (
            dialer.isOnCall || dialer.isConnecting ? (
              <ActionButton
                theme={theme}
              ...
              <ActionButton
                theme={theme}
                icon={dialer.isConnecting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Phone className="h-4 w-4" />}
                label="Call"
                raised={neumorphicRaised}
                pressed={neumorphicPressed}
                onClick={() => dialer.makeCall({ to: contact.phone!, contactId: contact.id, contactName: contact.name })}
              />
            )
          ) : (
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        <div className="flex gap-8 flex-col xl:flex-row">
          ...
          <div className="w-full xl:w-[300px] shrink-0 space-y-8">
            {/* Call Recordings */}
            <SidebarSection title="Calls" theme={theme} divider={dividerColor}>
              <CallRecordingsPanel contactId={contact.id} />
            </SidebarSection>
