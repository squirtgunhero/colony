...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // User already exists - Supabase returns empty identities array for existing emails
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f8f8f6]">
        <div className="w-full max-w-md px-4">
          ...
          <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-[rgba(0,0,0,0.04)] p-8 text-center">
            ...
            <Link 
              href="/sign-in" 
              className="inline-block mt-6 text-sm text-neutral-900 hover:underline font-medium"
            >
              Back to sign in
            </Link>
          </div>
      ...
      <div className="w-full max-w-md px-4">
        ...
        <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-[rgba(0,0,0,0.04)] p-8">
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-11 px-4 rounded-xl border border-neutral-200 focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 outline-none transition-colors text-neutral-900"
          ...
          <p className="mt-6 text-center text-sm text-neutral-500">
            ...
            <Link href="/sign-in" className="text-neutral-900 hover:underline font-medium">
              Sign in
            </Link>
          </p>
        </div>
